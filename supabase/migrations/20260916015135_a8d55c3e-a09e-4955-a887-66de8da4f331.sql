...
revoke all on function public.can_edit_employee(uuid) from public, anon;
grant execute on function public.has_role(uuid, public.app_role) to authenticated, service_role;
grant execute on function public.is_admin() to authenticated, service_role;
grant execute on function public.can_view_employee(uuid) to authenticated, service_role;
grant execute on function public.can_edit_employee(uuid) to authenticated, service_role;