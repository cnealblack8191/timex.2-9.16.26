    ...
    <div className="grid grid-cols-12 gap-5">
      ...
      <Panel className="col-span-12 flex flex-col p-4 xl:col-span-4">
        ...
        <button
          ...
          className="skew-btn mt-auto w-full rounded-xl bg-amber py-3.5 font-display text-[15px] tracking-wide text-ink transition-colors hover:bg-amber-deep disabled:cursor-not-allowed disabled:bg-ink/10 disabled:text-ink/50"
        >
