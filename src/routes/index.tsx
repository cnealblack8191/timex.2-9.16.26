  ...
  return (
    ...
    >
      <div className="grid grid-cols-12 gap-5">
        ...
        <Panel className="col-span-12 grid animate-rise grid-cols-12 items-center gap-6 p-4">
          <div className="col-span-12 md:col-span-5">
            <div className="mb-2 flex items-center gap-2">
              <span className="rounded bg-amber/15 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-amber-deep">
                Jobsite Kiosk
              </span>
              <span className="font-mono text-[11px] text-muted-foreground">
                Phone or tablet · works without signal
              </span>
            </div>
            <p className="text-pretty text-[13px] leading-relaxed text-steel">
              The on-site punch screen — pick a name, confirm the job, tap in or out. Punches made
              with no signal are stored on the device and sent the moment it reconnects.
            </p>
            <Link
              to="/kiosk"
              className="skew-btn mt-4 inline-block rounded-xl bg-ink px-5 py-3 font-display text-[15px] tracking-wide text-primary-foreground"
            >
          ...
          <div className="col-span-12 grid place-items-center py-4 md:col-span-7">
            <div className="w-full max-w-[380px] rounded-[26px] bg-kiosk p-5 text-primary-foreground ring-1 ring-ink/40">
              <div className="mb-4 flex items-center justify-between">
                ...
                <div className="font-mono text-2xl">07:00</div>
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between rounded-xl bg-primary-foreground/10 px-4 py-4 ring-1 ring-primary-foreground/10">
                  <span className="text-[12px] font-semibold uppercase tracking-wide text-primary-foreground/50">
                    Your name
                  </span>
                  <span className="text-[16px] font-bold">
                    {employees[0] ? fullName(employees[0]) : "—"}
                  </span>
                </div>
                <div className="flex items-center justify-between rounded-xl bg-primary-foreground/10 px-4 py-4 ring-1 ring-primary-foreground/10">
                  <span className="text-[12px] font-semibold uppercase tracking-wide text-primary-foreground/50">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="skew-btn rounded-xl bg-amber py-6 text-center font-display text-2xl tracking-wide text-ink">
                  <span>Clock In</span>
                </div>
                <div className="skew-btn rounded-xl bg-primary-foreground/10 py-6 text-center font-display text-2xl tracking-wide ring-1 ring-primary-foreground/20">
                  <span>Clock Out</span>
                </div>
              </div>
            </div>
...
function KioskCodePanel() {
  ...
  return (
    <form onSubmit={submit} className="mt-6 rounded-2xl bg-card/60 p-4 ring-1 ring-ink/5">
